...
type CartItem struct {
	ProductId int32 `thrift:"product_id,1,required" frugal:"1,required,i32" json:"product_id"`
...
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_CartItem[fieldId]))
}
...
type AddItemReq struct {
	...
	Item   *CartItem `thrift:"item,2,required" frugal:"2,required,CartItem" json:"item"`
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_AddItemReq[fieldId]))
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_EmptyCartReq[fieldId]))
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetCartReq[fieldId]))
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_Cart[fieldId]))
}
...
type GetCartResp struct {
	Cart *Cart `thrift:"cart,1,required" frugal:"1,required,Cart" json:"cart"`
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_GetCartResp[fieldId]))
}
...
type CartServiceGetCartArgs struct {
	Req *GetCartReq `thrift:"req,2" frugal:"2,default,GetCartReq" json:"req"`
}
...
func (p *CartServiceGetCartArgs) ReadField2(iprot thrift.TProtocol) error {
...
func (p *CartServiceGetCartArgs) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *CartServiceGetCartArgs) Field2DeepEqual(src *GetCartReq) bool {
...
type CartServiceEmptyCartArgs struct {
	Req *EmptyCartReq `thrift:"req,3" frugal:"3,default,EmptyCartReq" json:"req"`
}
...
func (p *CartServiceEmptyCartArgs) ReadField3(iprot thrift.TProtocol) error {
...
func (p *CartServiceEmptyCartArgs) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *CartServiceEmptyCartArgs) Field3DeepEqual(src *EmptyCartReq) bool {
