...
type RegisterReq struct {
	...
	ConfirmPassword string `thrift:"confirm_password,3,required" frugal:"3,required,string" json:"confirm_password"`
}
...
type UserServiceLoginArgs struct {
	Req *LoginReq `thrift:"req,2" frugal:"2,default,LoginReq" json:"req"`
}
...
func (p *UserServiceLoginArgs) Field2DeepEqual(src *LoginReq) bool {
