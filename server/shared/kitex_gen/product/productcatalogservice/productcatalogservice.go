...
func listProductsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(product.ProductCatalogService).ListProducts(ctx, realArg.Req)
	if err != nil {
		return err
	}
...
func searchProductsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(product.ProductCatalogService).SearchProducts(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
