...
type ListProductsReq struct {
	...
	CategoryName string `thrift:"categoryName,3,required" frugal:"3,required,string" json:"categoryName"`
}
...
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_ListProductsReq[fieldId]))
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_SearchProductsReq[fieldId]))
}
...
var ProductCatalogServiceListProductsArgs_Req_DEFAULT *ListProductsReq

func (p *ProductCatalogServiceListProductsArgs) GetReq() (v *ListProductsReq) {
	if !p.IsSetReq() {
		return ProductCatalogServiceListProductsArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *ProductCatalogServiceListProductsArgs) SetReq(val *ListProductsReq) {
	p.Req = val
}
...
func (p *ProductCatalogServiceListProductsArgs) IsSetReq() bool {
	return p.Req != nil
}
...
type ProductCatalogServiceGetProductArgs struct {
	Req *GetProductReq `thrift:"req,2" frugal:"2,default,GetProductReq" json:"req"`
}
...
func (p *ProductCatalogServiceGetProductArgs) ReadField2(iprot thrift.TProtocol) error {
...
func (p *ProductCatalogServiceGetProductArgs) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *ProductCatalogServiceGetProductArgs) Field2DeepEqual(src *GetProductReq) bool {
...
type ProductCatalogServiceSearchProductsArgs struct {
	Req *SearchProductsReq `thrift:"req,3" frugal:"3,default,SearchProductsReq" json:"req"`
}
...
var ProductCatalogServiceSearchProductsArgs_Req_DEFAULT *SearchProductsReq

func (p *ProductCatalogServiceSearchProductsArgs) GetReq() (v *SearchProductsReq) {
	if !p.IsSetReq() {
		return ProductCatalogServiceSearchProductsArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *ProductCatalogServiceSearchProductsArgs) SetReq(val *SearchProductsReq) {
	p.Req = val
}
...
func (p *ProductCatalogServiceSearchProductsArgs) IsSetReq() bool {
	return p.Req != nil
}
...
func (p *ProductCatalogServiceSearchProductsArgs) ReadField3(iprot thrift.TProtocol) error {
...
func (p *ProductCatalogServiceSearchProductsArgs) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *ProductCatalogServiceSearchProductsArgs) Field3DeepEqual(src *SearchProductsReq) bool {
