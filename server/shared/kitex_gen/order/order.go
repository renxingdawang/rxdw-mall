...
type Address struct {
	StreetAddress string `thrift:"street_address,1,required" frugal:"1,required,string" json:"street_address"`
	...
	Country       string `thrift:"country,4,required" frugal:"4,required,string" json:"country"`
	ZipCode       int32  `thrift:"zip_code,5,required" frugal:"5,required,i32" json:"zip_code"`
}
...
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_Address[fieldId]))
}
...
type OrderItem struct {
	Item *cart.CartItem `thrift:"item,1,required" frugal:"1,required,cart.CartItem" json:"item"`
	Cost int32          `thrift:"cost,2,required" frugal:"2,required,i32" json:"cost"`
}
...
func (p *OrderItem) GetCost() (v int32) {
	return p.Cost
}
func (p *OrderItem) SetItem(val *cart.CartItem) {
	p.Item = val
}
func (p *OrderItem) SetCost(val int32) {
	p.Cost = val
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_OrderItem[fieldId]))
}
...
func (p *OrderItem) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("cost", thrift.I32, 2); err != nil {
		goto WriteFieldBeginError
	}
...
type PlaceOrderReq struct {
	...
	UserCurrency string       `thrift:"user_currency,2,required" frugal:"2,required,string" json:"user_currency"`
	Address      *Address     `thrift:"address,3,required" frugal:"3,required,Address" json:"address"`
...
func (p *PlaceOrderReq) Read(iprot thrift.TProtocol) (err error) {
	...
	var issetUserCurrency bool = false
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_PlaceOrderReq[fieldId]))
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_OrderResult_[fieldId]))
}
...
type PlaceOrderResp struct {
	Order *OrderResult_ `thrift:"order,1,required" frugal:"1,required,OrderResult_" json:"order"`
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_PlaceOrderResp[fieldId]))
}
...
type Order struct {
	...
	OrderId      string       `thrift:"order_id,2,required" frugal:"2,required,string" json:"order_id"`
	UserId       int32        `thrift:"user_id,3,required" frugal:"3,required,i32" json:"user_id"`
	UserCurrency string       `thrift:"user_currency,4,required" frugal:"4,required,string" json:"user_currency"`
	Address      *Address     `thrift:"address,5,required" frugal:"5,required,Address" json:"address"`
	Email        string       `thrift:"email,6,required" frugal:"6,required,string" json:"email"`
	CreatedAt    int32        `thrift:"created_at,7,required" frugal:"7,required,i32" json:"created_at"`
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_MarkOrderPaidReq[fieldId]))
}
...
func (p *CancelOrderReq) GetUserId() (v int32) {
	return p.UserId
}
...
func (p *CancelOrderReq) SetUserId(val int32) {
	p.UserId = val
}
...
func (p *CancelOrderReq) Field1DeepEqual(src int32) bool {
...
func (p *CancelOrderReq) Field2DeepEqual(src string) bool {
...
func (p *CancelOrderResp) Field1DeepEqual(src bool) bool {
...
type OrderServiceListOrderArgs struct {
	Req *ListOrderReq `thrift:"req,2" frugal:"2,default,ListOrderReq" json:"req"`
}
...
func (p *OrderServiceListOrderArgs) ReadField2(iprot thrift.TProtocol) error {
...
func (p *OrderServiceListOrderArgs) writeField2(oprot thrift.TProtocol) (err error) {
...
func (p *OrderServiceListOrderArgs) Field2DeepEqual(src *ListOrderReq) bool {
...
type OrderServiceMarkOrderPaidArgs struct {
	Req *MarkOrderPaidReq `thrift:"req,3" frugal:"3,default,MarkOrderPaidReq" json:"req"`
}
...
func (p *OrderServiceMarkOrderPaidArgs) ReadField3(iprot thrift.TProtocol) error {
...
func (p *OrderServiceMarkOrderPaidArgs) writeField3(oprot thrift.TProtocol) (err error) {
...
func (p *OrderServiceMarkOrderPaidArgs) Field3DeepEqual(src *MarkOrderPaidReq) bool {
...
type OrderServiceCancelOrderArgs struct {
	Req *CancelOrderReq `thrift:"req,4" frugal:"4,default,CancelOrderReq" json:"req"`
}
...
func (p *OrderServiceCancelOrderArgs) ReadField4(iprot thrift.TProtocol) error {
...
func (p *OrderServiceCancelOrderArgs) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 4); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
		return err
...
func (p *OrderServiceCancelOrderArgs) DeepEqual(ano *OrderServiceCancelOrderArgs) bool {
	...
	if !p.Field4DeepEqual(ano.Req) {
		return false
	}
	return true
}

func (p *OrderServiceCancelOrderArgs) Field4DeepEqual(src *CancelOrderReq) bool {
