...
type CheckoutReq struct {
	...
	Firstname  string                  `thrift:"firstname,2,required" frugal:"2,required,string" json:"firstname"`
	Lastname   string                  `thrift:"lastname,3,required" frugal:"3,required,string" json:"lastname"`
	...
	CreditCard *payment.CreditCardInfo `thrift:"credit_card,6,required" frugal:"6,required,payment.CreditCardInfo" json:"credit_card"`
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_CheckoutReq[fieldId]))
}
...
type CheckoutResp struct {
	...
	Transaction string `thrift:"transaction,2,required" frugal:"2,required,string" json:"transaction"`
}
...
func (p *CheckoutResp) GetTransaction() (v string) {
	return p.Transaction
}
func (p *CheckoutResp) SetOrderId(val string) {
	p.OrderId = val
}
func (p *CheckoutResp) SetTransaction(val string) {
	p.Transaction = val
}
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_CheckoutResp[fieldId]))
}
...
func (p *CheckoutResp) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("transaction", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Transaction); err != nil {
		return err
	}
	if err = oprot.WriteFieldEnd(); err != nil {
		goto WriteFieldEndError
...
func (p *CheckoutResp) DeepEqual(ano *CheckoutResp) bool {
	...
	if !p.Field2DeepEqual(ano.Transaction) {
		return false
	}
	return true
}
...
func (p *CheckoutResp) Field2DeepEqual(src string) bool {
	...
	if strings.Compare(p.Transaction, src) != 0 {
		return false
	}
	return true
}
