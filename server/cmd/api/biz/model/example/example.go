...
func (p *HelloServiceClient) HelloMethod(ctx context.Context, req *HelloReq) (r *HelloResp, err error) {
...
var HelloServiceHelloMethodArgs_Req_DEFAULT *HelloReq

func (p *HelloServiceHelloMethodArgs) GetReq() (v *HelloReq) {
	if !p.IsSetReq() {
		return HelloServiceHelloMethodArgs_Req_DEFAULT
	}
	return p.Req
}
...
func (p *HelloServiceHelloMethodArgs) IsSetReq() bool {
	return p.Req != nil
}
